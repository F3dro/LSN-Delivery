...
fig.suptitle('Kripton, Solid Phase', y='0.92', size='20', weight='20')
gs = gridspec.GridSpec(4, 2, figure=fig)

f4 = np.loadtxt('solid/output_temp_2.dat')
...
x1, f1, error1 = np.loadtxt('solid/output_ave_temp_2.dat', usecols=(0,1,2), unpack='true')
...
f1 = np.loadtxt('solid/output_ekin_2.dat')
f2 = np.loadtxt('solid/output_epot_2.dat')
f3 = np.loadtxt('solid/output_etot_2.dat')
...
f4 = np.loadtxt('solid/output_pres_2.dat')
...
x1, f1, error1 = np.loadtxt('solid/output_ave_pres_2.dat', usecols=(0,1,2), unpack='true')
