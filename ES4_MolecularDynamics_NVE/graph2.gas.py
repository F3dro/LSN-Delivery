...
fig.suptitle('Kripton, Gas Phase', y='0.92', size='20', weight='20')
gs = gridspec.GridSpec(4, 2, figure=fig)

f4 = np.loadtxt('gas/output_temp_2.dat')
...
x1, f1, error1 = np.loadtxt('gas/output_ave_temp_2.dat', usecols=(0,1,2), unpack='true')
...
f1 = np.loadtxt('gas/output_ekin_2.dat')
f2 = np.loadtxt('gas/output_epot_2.dat')
f3 = np.loadtxt('gas/output_etot_2.dat')
...
x1, f1, error1 = np.loadtxt('gas/output_ave_ekin_1.dat', usecols=(0,1,2), unpack='true')
x2, f2, error2 = np.loadtxt('gas/output_ave_epot_1.dat', usecols=(0,1,2), unpack='true')
x3, f3, error3 = np.loadtxt('gas/output_ave_etot_1.dat', usecols=(0,1,2), unpack='true')
...
f4 = np.loadtxt('gas/output_pres_2.dat')
...
x1, f1, error1 = np.loadtxt('gas/output_ave_pres_2.dat', usecols=(0,1,2), unpack='true')
