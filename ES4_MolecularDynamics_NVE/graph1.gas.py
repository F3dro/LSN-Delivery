...
f4 = np.loadtxt('gas/output_temp_1.dat')
...
x1, f1, error1 = np.loadtxt('gas/output_ave_temp_1.dat', usecols=(0,1,2), unpack='true')
...
f1 = np.loadtxt('gas/output_ekin_1.dat')
f2 = np.loadtxt('gas/output_epot_1.dat')
f3 = np.loadtxt('gas/output_etot_1.dat')
...
f4 = np.loadtxt('gas/output_pres_1.dat')
...
x1, f1, error1 = np.loadtxt('gas/output_ave_pres_1.dat', usecols=(0,1,2), unpack='true')
